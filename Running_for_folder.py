...
path_to_folder = "../DATA\ALL DATA - Copy (4)"
...
for file in sorted(os.listdir(path_to_folder)):
    ...
    # with open("../Output/"+file[:-4]+".txt", "w") as f:
    #     f.write(all_text)
    ...
    if inv_num is None:
        ...
        if os.path.exists("./Report3.xlsx"):
            print('Updating excel file...')
            with pd.ExcelWriter("Report3.xlsx",mode="a",engine="openpyxl",if_sheet_exists="overlay") as writer:
            ...
            df.to_excel("Report3.xlsx",index=False)
            os.remove(path=file_path)
