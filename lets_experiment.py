...
path = "../DATA\ALL DATA\Europcar.pdf"
all_text = ""
summ = 0
...
with open("../Output/output_hertz1.txt", "w") as f:
    f.write(all_text)
...
if os.path.exists("./Report.xlsx"):
    ...
    with pd.ExcelWriter("Report.xlsx",mode="a",engine="openpyxl",if_sheet_exists="overlay") as writer:
